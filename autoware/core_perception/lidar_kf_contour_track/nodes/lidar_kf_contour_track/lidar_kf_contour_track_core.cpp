...
ContourTracker::ContourTracker()
{
  ...
  sub_cloud_clusters     = nh.subscribe("/detection/lidar_detector/cloud_clusters", 1, &ContourTracker::callbackGetCloudClusters, this);  // Changed by wang-ruifan: subscribe topic name from /cloud_clusters to /detection/lidar_detector/cloud_clusters
