...
**For English Version, [Click Me!](#road-sweeper-project)**

## 项目简介

- 这是一个小型自动驾驶路面清扫车的项目，基于Ubuntu 18.04，ROS Melodic，Autoware1.14。
- 使用的控制板为NVIDIA Jetson Xavier NX，底盘为线控底盘，使用CAN进行通信。
- 本仓库包含了修改后的Autoware代码、Autoware的底盘控制指令与CAN进行对接的包，激光雷达和IMU/GNSS驱动包，地图文件等。

### 此仓库为本人记录、留存用。不回复issue，不提供技术支持，不保证代码可用性
...
请查看[Source分支里的README](https://github.com/wang-ruifan/Road-sweeper/blob/source/README.md)查看详细安装指南
...
- This is a small-scale autonomous road sweeper project based on Ubuntu 18.04, ROS Melodic, and Autoware 1.14.
...
### This repository is for personal record and retention. Issues will not be responded to, technical support will not be provided, and the usability of the code is not guaranteed.
...
Please refer to the [README in the Source branch](https://github.com/wang-ruifan/Road-sweeper/blob/source/README.md) for detailed installation instructions.

## Usage Instructions

### Using Autoware-related functions

Refer to the [Autoware Usage Tutorial](docs/Autoware自动驾驶使用教程v1.2.pdf)
...
### Using launch files to start the sweeper
